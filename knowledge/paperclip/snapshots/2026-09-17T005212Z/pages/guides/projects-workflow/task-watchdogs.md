> Official reference snapshot. Source: https://docs.paperclip.ing/guides/projects-workflow/task-watchdogs/
> Retrieved: 2026-09-17T00:52:15.127845+00:00
...
[Image reference: Watchdog lifecycle: attach, work runs, subtree stops, review task opens, outcome posts, fingerprint settles](https://docs.paperclip.ing/guides/user-guides/screenshots/diagrams/task-watchdog-lifecycle.png)
...
[Image reference: A watchdog review outcome posted back to the task thread, with its disposition and verified evidence.](https://docs.paperclip.ing/guides/projects-workflow/task-watchdogs/user-guides/screenshots/dark/watchdogs/watchdog-thread-outcome.png)
...
And if what you really want is "wake me when this is done," reach for a [routine](https://docs.paperclip.ing/guides/projects-workflow/routines/) or an issue-thread interaction instead.

---

## Where to go next

- [Heartbeats & Routines](https://docs.paperclip.ing/guides/projects-workflow/routines/) — timer- and event-driven wakes, the other way to keep work moving.
- [Projects](https://docs.paperclip.ing/guides/projects-workflow/projects/) — how issue trees are organized in the first place.
