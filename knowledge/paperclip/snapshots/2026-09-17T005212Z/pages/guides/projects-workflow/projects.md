> Official reference snapshot. Source: https://docs.paperclip.ing/guides/projects-workflow/projects/
> Retrieved: 2026-09-17T00:52:14.902115+00:00
...
[Image reference: Project list](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/list.png)
...
[Image reference: Overview tab](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/overview.png)
...
[Image reference: Issues tab](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/issues.png)
...
Each issue may be tied to an execution workspace — a specific working copy of the project's code — when the issue is picked up by an agent. The Workspaces tab (next section) groups issues by the workspace they are running in, which is often a more useful lens once work is in flight. See [Execution Workspaces](https://docs.paperclip.ing/guides/projects-workflow/workspaces/) for the underlying model.
...
[Image reference: Workspaces tab](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/workspaces.png)
...
[Image reference: Configuration tab](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/configuration.png)
...
- **Goals** — the list of goals the project is linked to. Add or remove goal links here; linked goals appear on the Overview area and in the properties panel. See the [Goals guide](https://docs.paperclip.ing/guides/projects-workflow/goals/) for the goal model.
...
These settings map to the behaviours described in [Execution Workspaces](https://docs.paperclip.ing/guides/projects-workflow/workspaces/). You will usually set them once per project and rarely touch them again.
...
Project budgets are useful when a single project needs a hard spending ceiling independent of the agent doing the work. For a first principles tour of budgeting, see [Costs & Budgets](https://docs.paperclip.ing/guides/day-to-day/costs/).

[Image reference: Budget tab](https://docs.paperclip.ing/guides/projects-workflow/projects/user-guides/screenshots/dark/projects/budget.png)
...
See [Costs & Budgets](https://docs.paperclip.ing/guides/day-to-day/costs/) for how these three interact, how to read the company-wide cost overview, and how to resolve a budget override approval when a hard stop is reached.
...
- Task-level work: [Managing Tasks](https://docs.paperclip.ing/guides/day-to-day/issues/).
- The goal model that sits above projects: [Goals](https://docs.paperclip.ing/guides/projects-workflow/goals/).
- The execution surface beneath projects: [Execution Workspaces](https://docs.paperclip.ing/guides/projects-workflow/workspaces/).
- Budget mechanics in more depth: [Costs & Budgets](https://docs.paperclip.ing/guides/day-to-day/costs/).
