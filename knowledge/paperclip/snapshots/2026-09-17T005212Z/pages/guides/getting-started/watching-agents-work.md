> Official reference snapshot. Source: https://docs.paperclip.ing/guides/getting-started/watching-agents-work/
> Retrieved: 2026-09-17T00:52:13.461846+00:00
...
1. **Enable the CEO's heartbeat**
  ...
  [Image reference: The agent detail page with the heartbeat toggle in its disabled state](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/agents/heartbeat-toggle-disabled.png)
  ...
  [Image reference: The agent detail page with the heartbeat toggle in its enabled state](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/agents/heartbeat-toggle-enabled.png)
...
2. **Wait for the first heartbeat to run**
  ...
  [Image reference: The agent detail page showing the CEO in &quot;running&quot; status with a live progress indicator](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/agents/agent-status-running.png)
  ...
  [Image reference: The run history section showing a heartbeat in progress](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/agents/run-history-in-progress.png)
...
3. **Review the CEO's strategy**
  ...
  [Image reference: The approvals queue showing a pending strategy approval from the CEO](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/approvals/approvals-queue-strategy.png)
  ...
  [Image reference: The strategy approval detail page showing the CEO&#39;s proposed plan](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/approvals/strategy-approval-detail.png)
...
4. **Approve, reject, or request revisions**
  ...
  [Image reference: The approve, request revision, and reject buttons on the strategy approval page](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/approvals/approve-reject-buttons.png)
...
5. **Watch tasks appear**
  ...
  [Image reference: The task inbox showing newly created tasks from the CEO&#39;s first planning heartbeat](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/tasks/inbox-newly-created-tasks.png)
...
6. **Read a task's comment thread**
  ...
  [Image reference: A task detail page showing the comment thread with the CEO&#39;s working notes](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/tasks/task-detail-with-comments.png)
...
[Image reference: The run transcript view showing the full log of what the CEO did during a single heartbeat](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/user-guides/screenshots/dark/agents/run-transcript-view.png)
...
[Go to The Dashboard →](https://docs.paperclip.ing/guides/day-to-day/dashboard/)
