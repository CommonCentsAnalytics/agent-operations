> Official reference snapshot. Source: https://docs.paperclip.ing/guides/getting-started/your-first-company/
> Retrieved: 2026-09-17T00:52:13.223582+00:00
...
Make sure Paperclip is installed and running. If you haven't done that yet, start with the [Installation guide](https://docs.paperclip.ing/guides/getting-started/installation/).
...
1. **Open the setup wizard**
  ...
  [Image reference: The sidebar organization switcher with the Create new organization option highlighted](https://docs.paperclip.ing/guides/getting-started/your-first-company/user-guides/screenshots/dark/onboarding/sidebar-new-company-button.png)
...
2. **Name your organization**
  ...
  [Image reference: The setup wizard&#39;s first screen asking for the organization name](https://docs.paperclip.ing/guides/getting-started/your-first-company/user-guides/screenshots/dark/onboarding/new-company-modal-empty.png)
...
3. **Click Continue**
  ...
  Click **Continue**. Paperclip creates the organization and takes you straight to the next screen — hiring your first agent, which the [next guide](https://docs.paperclip.ing/guides/getting-started/your-first-agent/) covers in full.
