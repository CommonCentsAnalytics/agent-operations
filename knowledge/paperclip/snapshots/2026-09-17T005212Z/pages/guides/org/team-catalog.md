> Official reference snapshot. Source: https://docs.paperclip.ing/guides/org/team-catalog/
> Retrieved: 2026-09-17T00:52:14.416300+00:00
...
Where a [skill](https://docs.paperclip.ing/guides/org/skills/) is one reusable procedure, a *team* is a whole unit of people and work. Install one and you get the agents, the org structure between them, the projects they work in, the recurring tasks that keep them moving, and the skills they rely on — all wired together the way a working team would already have them.
...
For every command, flag, and the permission-fallback details, see the [Teams CLI reference](https://docs.paperclip.ing/reference/cli/teams/).

---

## See also

- [Teams CLI reference](https://docs.paperclip.ing/reference/cli/teams/) — the full `teams` command surface.
- [Skills](https://docs.paperclip.ing/guides/org/skills/) — the single-capability catalog that catalog teams build on.
- [Org structure](https://docs.paperclip.ing/guides/org/org-structure/) — how reporting lines work, which catalog teams plug into.
- [Agents](https://docs.paperclip.ing/guides/org/agents/) — configuring the agents an install creates.
