> Official reference snapshot. Source: https://docs.paperclip.ing/guides/org/org-structure/
> Retrieved: 2026-09-17T00:52:14.356042+00:00
...
1. **Go to the Agents page and click "New Agent"**
  ...
  [Image reference: Agents list page showing the New Agent button](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/agents/agents-list-empty.png)
2. **Set the name, title, and role**
  ...
  [Image reference: New agent form with name and role fields](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/agents/new-agent-name-role.png)
3. **Set "Reports to" to the CEO**
  ...
  [Image reference: New agent form showing the Reports to dropdown with CEO selected](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/agents/new-agent-reports-to-field.png)
4. **Choose an adapter and save**

   

  Configure the adapter (see [Agent Adapters](https://docs.paperclip.ing/guides/org/agent-adapters/) if you need help with this step). Click **Create agent**.
...
[Image reference: Org chart view showing the full reporting hierarchy with agent status indicators](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/org/org-chart-small-team.png)
...
[Image reference: Interactive org chart showing the CEO at the top with managers and workers connected by reporting lines](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/org/chart.png)
...
[Image reference: Agent configuration with the Reports to dropdown expanded, selecting a new manager](https://docs.paperclip.ing/guides/org/org-structure/user-guides/screenshots/dark/org/reassign.png)
...
[Delegation →](https://docs.paperclip.ing/guides/org/delegation/)
