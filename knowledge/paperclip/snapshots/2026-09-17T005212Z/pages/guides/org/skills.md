> Official reference snapshot. Source: https://docs.paperclip.ing/guides/org/skills/
> Retrieved: 2026-09-17T00:52:14.333468+00:00
...
[Image reference: Add skill dialog with the source input, search button, and link to skills.sh](https://docs.paperclip.ing/guides/org/skills/user-guides/screenshots/dark/skills/add-skill-dialog.png)
...
[Image reference: Skills page showing available skills with their names and descriptions](https://docs.paperclip.ing/guides/org/skills/user-guides/screenshots/dark/org/skills-list.png)
...
If you want to script any of this — creating folders, moving skills between them, reordering — the whole tree is available over REST. See the [Folders API](https://docs.paperclip.ing/reference/api/folders/) for the field shapes, nesting limits, and the rules around system-managed folders.
...
Open it from a skill in your library, or go straight to `/skills/studio`. The breadcrumb reads **Skills → Studio →** so you always know where you are.
...
- **Only Paperclip-managed skills can be renamed.** Skills from the built-in catalog, GitHub, skills.sh, or a project scan are read-only for the same reason their contents are — see [Editing a skill that isn't yours to edit](https://docs.paperclip.ing/guides/org/skills/#editing-a-skill-that-isnt-yours-to-edit) if you want an editable copy you *can* rename.
...
- **It obeys the skill policy.** Renaming counts as an edit, so if your company restricts who may change skills, the same rule applies here — see [Who is allowed to change skills](https://docs.paperclip.ing/guides/org/skills/#who-is-allowed-to-change-skills).
...
For the policy document shape, the eight skill actions, and how a decision is reached, see the [Company Skill Policy API](https://docs.paperclip.ing/reference/api/company-skill-policy/).
...
[Image reference: Skill detail pane showing the file tree with SKILL.md plus a references folder, and metadata badges for source, pin, key, and editable state](https://docs.paperclip.ing/guides/org/skills/user-guides/screenshots/dark/skills/file-inventory.png)
...
[Image reference: Agent Skills tab with required, optional, and unmanaged sections, plus a link to the company skill library](https://docs.paperclip.ing/guides/org/skills/user-guides/screenshots/dark/skills/assign-to-agent.png)
...
It is off by default everywhere — cloud and self-hosted alike — and it is not one of the cloud-managed flags, so it stays yours to turn on and off on any instance. See [Experimental features](https://docs.paperclip.ing/experimental/overview/) for how that page behaves.
...
You can also scan and import skills from project workspaces when you already have skill files on disk. That's useful for teams migrating existing `SKILL.md` folders into the Paperclip library — see [Import skills straight from a project](https://docs.paperclip.ing/guides/org/skills/#5-import-skills-straight-from-a-project).
...
- [Skills reference](https://docs.paperclip.ing/reference/skills/) — everything about how skills work on disk and over the wire.
- [Agents API → Skills](https://docs.paperclip.ing/reference/api/agents/#skills) — request/response shapes for the agent-level routes.
- [Folders API](https://docs.paperclip.ing/reference/api/folders/) — creating, nesting, and reordering the skill folder tree.
- [Company Skill Policy API](https://docs.paperclip.ing/reference/api/company-skill-policy/) — restricting who may create, import, edit, test, or remove skills.
