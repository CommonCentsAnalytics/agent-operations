> Official reference snapshot. Source: https://docs.paperclip.ing/guides/org/agents/
> Retrieved: 2026-09-17T00:52:14.345261+00:00
...
[Image reference: Agent list](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/list.png)
...
2. An existing agent (typically the CEO or a manager) proposes a hire, which lands in your approval queue. See [Approvals](https://docs.paperclip.ing/guides/day-to-day/approvals/) for how that side works.

This section is about the direct path — the `New Agent` form.

[Image reference: Hire a new agent](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/new.png)
...
See [Agent adapters](https://docs.paperclip.ing/guides/org/agent-adapters/) for a full tour of each adapter and when to use it.
...
> **Danger:** Terminate permanently shuts the agent down. Use Pause if you might want it back. See [Approvals — Board Override Powers](https://docs.paperclip.ing/guides/day-to-day/approvals/#board-override-powers) for the broader discussion of Pause vs Terminate vs Delete.
...
[Image reference: Dashboard tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/dashboard.png)
...
At the bottom, a summary of the agent's total input tokens, output tokens, cached tokens, and total cost, followed by a per-run cost table for the most recent 10 runs. For a deeper view of spending — and the rules for how the numbers are computed — see [Costs & budgets](https://docs.paperclip.ing/guides/day-to-day/costs/).
...
[Image reference: Instructions tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/instructions.png)
...
The Skills tab controls which company skills are attached to this specific agent. It is a per-agent view over the shared [company skill library](https://docs.paperclip.ing/guides/org/skills/) — the library is where skills are authored and imported, this tab is where you decide which agents get which skills.

[Image reference: Skills tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/skills.png)
...
For a deeper discussion of what skills are, how to write good ones, and how they keep the agent's context small, see [Skills](https://docs.paperclip.ing/guides/org/skills/).
...
[Image reference: Configuration tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/configuration.png)
...
Below the form, still on the Configuration tab, is a dedicated **API Keys** block. This is the same UI described under the Keys tab below — it's embedded here because issuing a key is a configuration-time action. See [Keys](https://docs.paperclip.ing/guides/org/agents/#keys) for the details.
...
[Image reference: Runs tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/runs.png)
...
[Image reference: Budget tab](https://docs.paperclip.ing/guides/org/agents/user-guides/screenshots/dark/agents/budget.png)
...
This tab configures **this agent's** budget. Paperclip also tracks a company-level budget that sums across agents. See [Costs & budgets](https://docs.paperclip.ing/guides/day-to-day/costs/) for how the two interact, how API costs are computed, and how to tune budgets as a portfolio rather than one agent at a time.
...
3. If the change is within your authority, it saves immediately. If the agent is subordinate and an override is required, a Budget Override approval is created — see [Approvals](https://docs.paperclip.ing/guides/day-to-day/approvals/).
...
- [Skills](https://docs.paperclip.ing/guides/org/skills/) — how the company skill library works, how skills are written, and how they keep agent context lean
- [Agent adapters](https://docs.paperclip.ing/guides/org/agent-adapters/) — which adapters are available, what each one is good at, and how to configure them
- [Approvals](https://docs.paperclip.ing/guides/day-to-day/approvals/) — the governance layer around hire requests, strategy, and budget overrides
- [Costs & budgets](https://docs.paperclip.ing/guides/day-to-day/costs/) — how API spend is computed, how budgets are enforced, and how to tune them across your whole company
