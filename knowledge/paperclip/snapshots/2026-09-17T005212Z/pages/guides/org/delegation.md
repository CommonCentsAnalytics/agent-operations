> Official reference snapshot. Source: https://docs.paperclip.ing/guides/org/delegation/
> Retrieved: 2026-09-17T00:52:14.584272+00:00
...
[Image reference: Approvals page showing a pending strategy approval](https://docs.paperclip.ing/guides/org/delegation/user-guides/screenshots/dark/approvals/approvals-queue-strategy.png)
...
You'll find more on the banner and where it appears in [Agents → The Agent Detail Page](https://docs.paperclip.ing/guides/org/agents/#the-agent-detail-page).
