> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/approvals/
> Retrieved: 2026-09-17T00:52:13.936563+00:00
...
[Image reference: Approvals list page showing pending approvals with type badges, requesting agent names, and creation timestamps](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/approvals-list.png)
...
1. **Open the Approvals page**
  ...
  [Image reference: Approvals list showing a pending hire request and a pending strategy approval](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/approvals-list.png)
...
[Image reference: Approvals tab bar with Pending and All tabs and a pending count pill](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/queue-filters.png)
...
[Image reference: Hire approval detail showing proposed agent name, role, capabilities description, adapter type, and budget](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/hire-approval-detail.png)
...
3. **Make your decision**
  ...
  [Image reference: Approve, Reject, and Request Revision buttons at the bottom of an approval detail](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/approve-reject-revision-buttons.png)
...
[Image reference: Strategy approval detail showing the CEO&#39;s proposed plan and a list of linked draft issues](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/strategy-approval-detail.png)
...
1. **Click on the strategy approval**
  ...
  [Image reference: Strategy approval detail showing the CEO&#39;s proposed strategic plan and the tasks it intends to create](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/strategy-approval-detail.png)
...
3. **Approve or request changes**
  ...
  [Image reference: Revision request input box with a text field for explaining what changes are needed](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/revision-request-input.png)
...
[Image reference: An approved approval showing the approved status badge and the timestamp of the decision](https://docs.paperclip.ing/guides/day-to-day/approvals/user-guides/screenshots/dark/approvals/approved-approval.png)
