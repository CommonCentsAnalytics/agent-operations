> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/activity-log/
> Retrieved: 2026-09-17T00:52:14.123108+00:00
...
If the question you're really asking is "what did my *agents* do, and on whose behalf?", you don't need a different page anymore. Activity is now one page for both questions: flip the scope toggle to narrow from every actor down to agent actions only, without leaving the feed. See [Focusing on agent actions](https://docs.paperclip.ing/guides/day-to-day/activity-log/#focusing-on-agent-actions) below.

[Image reference: Activity Log page showing a full chronological feed of events with actor names, action descriptions, and timestamps](https://docs.paperclip.ing/guides/day-to-day/activity-log/user-guides/screenshots/dark/activity/activity-log-full.png)
...
[Image reference: Activity Log detail view for a single event, showing actor, action, before/after values, and timestamp](https://docs.paperclip.ing/guides/day-to-day/activity-log/user-guides/screenshots/dark/activity/activity-log-full.png)
...
[Image reference: Activity Log with the filter bar open, showing the scope toggle plus agent, responsible user, action, entity, and date range filters](https://docs.paperclip.ing/guides/day-to-day/activity-log/user-guides/screenshots/dark/activity/activity-filters.png)
...
[Image reference: Activity Log filtered to show one category of events](https://docs.paperclip.ing/guides/day-to-day/activity-log/user-guides/screenshots/dark/activity/activity-filtered-by-agent.png)
...
[Building Your Org Structure →](https://docs.paperclip.ing/guides/org/org-structure/)
