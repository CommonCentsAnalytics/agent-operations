> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/artifacts/
> Retrieved: 2026-09-17T00:52:13.699183+00:00
...
> **Experimental:** the tab only exists when **Chat-Style Tasks** is enabled in **Settings → Instance settings → Experimental**. With the flag off, a task's attachments stay in the **Attachments** section on the task page. See [Experimental features](https://docs.paperclip.ing/experimental/overview/).

Either way, the Artifacts page remains the place to see everything at once, across every task and project. See [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/#tabs-in-the-properties-panel-experimental) for the rest of what those tabs hold.
