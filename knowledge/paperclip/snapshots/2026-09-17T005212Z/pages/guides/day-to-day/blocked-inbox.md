> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/blocked-inbox/
> Retrieved: 2026-09-17T00:52:13.862324+00:00
...
[Image reference: Inbox](https://docs.paperclip.ing/guides/day-to-day/blocked-inbox/user-guides/screenshots/dark/issues/inbox.png)
...
The owner column is more reliable than it used to be — see [Who owns the unblock](https://docs.paperclip.ing/guides/day-to-day/blocked-inbox/#who-owns-the-unblock) below.
...
The Blocked tab reuses the same filter and search machinery as the rest of the Issues UI, so anything you've learned about the [Issues page](https://docs.paperclip.ing/guides/day-to-day/issues/) carries over.
...
- [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/) — the full Issues page, status reference, and the rest of the Inbox tabs (Mine / Recent / Unread / All).
- [Approvals](https://docs.paperclip.ing/guides/day-to-day/approvals/) — the governance gate that often appears as a *Needs decision* chip on the Blocked tab.
