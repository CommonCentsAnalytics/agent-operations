> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/costs/
> Retrieved: 2026-09-17T00:52:14.083392+00:00
...
[Image reference: Overview tab](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/overview.png)
...
[Image reference: Budgets tab](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/budgets.png)
...
1. **Open the Costs page**
  ...
  [Image reference: Company settings page showing the Monthly Budget field](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/company-budget-field.png)
...
1. **Open the agent's Budget tab**
  ...
  [Image reference: Agent budget field in the agent configuration panel](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/agent-budget-field.png)
2. **Set the monthly budget**
...
[Image reference: Agent budget bar at approximately 50% — green, no warning](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/agent-budget-50pct.png)

*Normal operation — green bar, no action needed.*

[Image reference: Agent budget bar at 80% — amber warning state](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/agent-budget-80pct-warning.png)

*Warning threshold reached — this is your signal to intervene before the hard stop.*

[Image reference: Agent budget bar at 100% — red, agent shown as paused](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/agent-budget-100pct-paused.png)
...
[Image reference: Providers tab](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/providers.png)
...
[Image reference: Billers tab](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/billers.png)
...
[Image reference: Finance tab](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/finance.png)
...
[Image reference: Cost Summary dashboard panel showing per-agent budget bars, two green and one amber](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/costs-dashboard-overview.png)
...
[Image reference: Per-run cost detail showing model, input tokens, output tokens, and dollar cost for each heartbeat](https://docs.paperclip.ing/guides/day-to-day/costs/user-guides/screenshots/dark/costs/per-run-cost-detail.png)
