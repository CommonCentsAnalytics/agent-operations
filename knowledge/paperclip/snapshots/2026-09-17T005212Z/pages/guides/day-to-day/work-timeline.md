> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/work-timeline/
> Retrieved: 2026-09-17T00:52:14.118349+00:00
...
[Image reference: The company Work Timeline: one lane per actor, bars for work periods, overlapping work visible across lanes.](https://docs.paperclip.ing/guides/day-to-day/work-timeline/user-guides/screenshots/dark/work-timeline/work-timeline-overview.png)
...
[Image reference: A handoff on the timeline: the upper actor&#39;s bar ends where the lower actor&#39;s bar begins.](https://docs.paperclip.ing/guides/day-to-day/work-timeline/user-guides/screenshots/dark/work-timeline/work-timeline-handoff.png)
...
In practice the two compose. After an overnight batch or a busy release period, start with the timeline to see the shape of what happened, then drop into the Activity Log or a specific run for the events behind any bar that surprises you. If you are auditing exactly what happened and who did it, the ledger is the record. And if what you want is to follow a single agent live while it executes, that is a different job again; the [Watching Agents Work](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/) guide covers it.

## Further reading

- [Activity Log](https://docs.paperclip.ing/guides/day-to-day/activity-log/), the event ledger: every event in the company, in order, with actor and timestamp.
- [Watching Agents Work](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/), following a single agent live through an execution cycle.
