> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/work-modes/
> Retrieved: 2026-09-17T00:52:13.715617+00:00
...
[Image reference: A standard-mode task mid-execution, with its workspace attached and the agent working in the thread.](https://docs.paperclip.ing/guides/day-to-day/work-modes/user-guides/screenshots/dark/work-modes/standard-mode-run.png)
...
[Image reference: An ask-mode task where the question is the description and the agent&#39;s recommendation comes back as a reply in the thread.](https://docs.paperclip.ing/guides/day-to-day/work-modes/user-guides/screenshots/dark/work-modes/ask-mode-answer.png)
...
[Image reference: A plan-mode task showing the plan document the agent produced for review instead of executed work.](https://docs.paperclip.ing/guides/day-to-day/work-modes/user-guides/screenshots/dark/work-modes/plan-mode-plan.png)
...
[Image reference: The work-mode selector on the new-task form, offering Agent mode, Plan mode, and Ask mode.](https://docs.paperclip.ing/guides/day-to-day/work-modes/user-guides/screenshots/dark/work-modes/work-mode-picker.png)
