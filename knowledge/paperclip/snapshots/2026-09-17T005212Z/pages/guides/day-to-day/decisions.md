> Official reference snapshot. Source: https://docs.paperclip.ing/guides/day-to-day/decisions/
> Retrieved: 2026-09-17T00:52:13.907242+00:00
...
[Image reference: The Decisions page: a ranked queue of items needing a human call, each row naming why it needs you and linking to the work behind it](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/queue-overview.png)
...
[Image reference: An agent-proposed decision expanded in the queue: the question, who proposed it and during which task, and each option as its own button](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/decision-card.png)
...
[Image reference: The Decided section expanded at the bottom of the queue, showing a resolved decision and the option that was chosen](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/history-curtains.png)
...
[Image reference: The Decisions toolbar with the filter panel open, showing the Type, Severity, Project, and Workspace sections](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/toolbar-filters.png)
...
You can also create queues of your own, add and remove items, and read a queue's contents through the [Decisions API](https://docs.paperclip.ing/reference/api/decisions/). One thing worth knowing: a queue only ever shows you items you are allowed to see, and its item count is counted the same way, so two people can look at the same queue and see different totals.

[Image reference: A named decision queue showing only the items routed into that lane](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/named-queue.png)
...
[Image reference: The triage strip on an expanded row: a When to decide row offering Today, This week, Whenever, and Pick date, alongside Queues and Snooze controls](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/triage-chips.png)
...
Set triage in the UI with the **When to decide** row on an expanded item. You can also set it through the [Decisions API](https://docs.paperclip.ing/reference/api/decisions/).
...
[Image reference: The empty Decisions queue reading You&#39;re all caught up](https://docs.paperclip.ing/guides/day-to-day/decisions/user-guides/screenshots/dark/decisions/empty-state.png)

---

## Related

- [Approvals](https://docs.paperclip.ing/guides/day-to-day/approvals/) — review and resolve formal approval requests.
- [Blocked Inbox](https://docs.paperclip.ing/guides/day-to-day/blocked-inbox/) — focus specifically on stopped issues.
- [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/) — inspect and guide the work behind a decision.
- [Attention API](https://docs.paperclip.ing/reference/api/attention/) — build a board-facing integration around the same queue.
- [Decisions API](https://docs.paperclip.ing/reference/api/decisions/) — propose and resolve decisions, and manage queues and triage.
- [Decision Training](https://docs.paperclip.ing/reference/api/decision-training/) — keep a decision as a labelled training example, and export what you have collected.
