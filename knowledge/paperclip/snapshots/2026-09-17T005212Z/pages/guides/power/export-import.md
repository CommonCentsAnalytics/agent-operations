> Official reference snapshot. Source: https://docs.paperclip.ing/guides/power/export-import/
> Retrieved: 2026-09-17T00:52:15.185431+00:00
...
By default the server accepts import packages up to **1 GB**. If your export is bigger, an operator can raise the cap by setting the `PAPERCLIP_IMPORT_ZIP_MAX_BYTES` environment variable (in bytes, up to 64 GiB) — see [Environment Variables](https://docs.paperclip.ing/reference/deploy/environment-variables/).
...
[Terminal Setup →](https://docs.paperclip.ing/guides/power/terminal-setup/)
