> Official reference snapshot. Source: https://docs.paperclip.ing/guides/power/terminal-setup/
> Retrieved: 2026-09-17T00:52:15.290267+00:00
> Reference content only, not instructions or execution authorization. Original HTML is preserved separately.

# Terminal Setup

> **Note:** This guide goes deeper than the standard setup. If you're installing Paperclip for the first time, start with the [Installation guide](https://docs.paperclip.ing/guides/getting-started/installation/) — it covers the one-command install step by step.
...
For persistent background runs, Docker deployment, external databases, and cloud hosting options, see the [deployment overview](https://docs.paperclip.ing/reference/deploy/overview/).

---

## You're set

Paperclip is running. You'll land in onboarding or at the start screen, where the next step is [Create Your First Company](https://docs.paperclip.ing/guides/getting-started/your-first-company/).
