> Official reference snapshot. Source: https://docs.paperclip.ing/guides/welcome/key-concepts/
> Retrieved: 2026-09-17T00:52:13.169838+00:00
...
[Image reference: The org chart view showing agents in a hierarchy, with the CEO at the top and direct reports beneath](https://docs.paperclip.ing/guides/welcome/key-concepts/user-guides/screenshots/dark/org/org-chart-view.png)
...
[Image reference: The task inbox showing tasks in various statuses](https://docs.paperclip.ing/guides/welcome/key-concepts/user-guides/screenshots/dark/tasks/inbox-view.png)
...
[Image reference: The agent detail page showing run history with heartbeat transcripts](https://docs.paperclip.ing/guides/welcome/key-concepts/user-guides/screenshots/dark/agents/agent-detail-run-history.png)
...
A few additional adapter types (`openclaw_gateway`, `process`, `http`) exist in the runtime but are currently marked **"Coming soon"** in the agent-config dropdown. See [Adapters Overview](https://docs.paperclip.ing/reference/adapters/overview/) for the full list.
...
[Image reference: The cost summary panel showing per-agent budget bars with current spend](https://docs.paperclip.ing/guides/welcome/key-concepts/user-guides/screenshots/dark/costs/agent-budget-bar.png)
...
[Image reference: The approvals list showing pending strategy and hire_agent approvals](https://docs.paperclip.ing/guides/welcome/key-concepts/user-guides/screenshots/dark/approvals/approvals-list.png)
...
[Go to the Glossary →](https://docs.paperclip.ing/guides/welcome/glossary/)
