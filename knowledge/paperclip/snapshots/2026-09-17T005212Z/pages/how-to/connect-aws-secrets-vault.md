> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/connect-aws-secrets-vault/
> Retrieved: 2026-09-17T00:52:16.838202+00:00
...
If you only need the conceptual model — strict mode, the local encrypted provider, environment overrides — read [Secrets](https://docs.paperclip.ing/reference/deploy/secrets/) first. This page is the operator setup walkthrough.
...
- [Secrets](https://docs.paperclip.ing/reference/deploy/secrets/) — the secret-store model, strict mode, and how secret refs resolve at runtime.
- [Secrets API](https://docs.paperclip.ing/reference/api/secrets/#rotating-an-external-reference-secret) — the same value write from the API, including every validation rule.
- [Update or rotate a provider API key](https://docs.paperclip.ing/how-to/rotate-provider-api-key/) — Path B uses provider vaults like the one created above.
