> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/community-desktop-app/
> Retrieved: 2026-09-17T00:52:17.267624+00:00
...
The **officially supported ways to run Paperclip** are the [Terminal and Server / VPS installs](https://docs.paperclip.ing/guides/getting-started/installation/). Everything else in these docs assumes one of those. Once the app is running, though, the product is identical — companies, agents, issues, and budgets all work the same regardless of how the instance was started.
...
After selecting Local, the app finishes starting up and takes you into onboarding. From there, follow the normal guides: you'll need an [API key](https://docs.paperclip.ing/guides/getting-started/installation/) from Anthropic or OpenAI before agents can do any work, and then you can [create your first company](https://docs.paperclip.ing/guides/getting-started/your-first-company/).

### Connecting to a server you deployed

If your team runs a [Server / VPS install](https://docs.paperclip.ing/guides/getting-started/installation/), anyone can point the app at it:
...
> **Tip:** Community releases follow the same calendar version as the Paperclip CLI, but they're packaged separately and may lag the CLI by a day or two. If you need a fix the moment it ships, the [terminal install](https://docs.paperclip.ing/guides/getting-started/installation/) is always current.
...
- [Installation](https://docs.paperclip.ing/guides/getting-started/installation/) — the officially supported Terminal and Server / VPS installs.
- [Update Paperclip](https://docs.paperclip.ing/how-to/update-paperclip/) — updating the supported install paths.
- [Back Up and Restore a Company](https://docs.paperclip.ing/how-to/back-up-and-restore-a-company/) — take snapshots of your data whichever way you run Paperclip.
