> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/offboard-a-member/
> Retrieved: 2026-09-17T00:52:16.189924+00:00
...
[Image reference: Members page](https://docs.paperclip.ing/how-to/offboard-a-member/user-guides/screenshots/dark/company/access.png)
...
[Image reference: Instance Access page](https://docs.paperclip.ing/how-to/offboard-a-member/user-guides/screenshots/dark/settings/instance-access.png)
...
An instance admin can reach *every* company regardless of individual memberships, so this step matters if it applies. See [Settings → Instance: Access](https://docs.paperclip.ing/administration/settings/#instance-access) and [Roles & Permissions](https://docs.paperclip.ing/administration/roles-and-permissions/#instance-admin-the-layer-above-companies).

---

## 6. Verify

Back on **Settings → Members**, the member shows a `suspended` badge or has dropped off the active list. The membership record and its history remain for audit — every status change is written to the [activity log](https://docs.paperclip.ing/guides/day-to-day/activity-log/) — so you can always see who was removed, when, and by whom.
...
- [Roles & Permissions](https://docs.paperclip.ing/administration/roles-and-permissions/) — the access model these status changes plug into.
- [Company Administration](https://docs.paperclip.ing/administration/company/#members) — the Members page.
- [Settings](https://docs.paperclip.ing/administration/settings/#instance-access) — the Instance Access screen.
- [Add a human teammate](https://docs.paperclip.ing/how-to/add-a-human-teammate/) — the onboarding direction.
