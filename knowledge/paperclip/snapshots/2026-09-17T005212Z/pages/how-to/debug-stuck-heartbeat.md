> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/debug-stuck-heartbeat/
> Retrieved: 2026-09-17T00:52:17.060688+00:00
...
**Fix.** Agent → **Run Policy → Heartbeat on interval**. Turn it off and rely on assignment-driven wakes. See [Heartbeats & Routines](https://docs.paperclip.ing/guides/projects-workflow/routines/).
...
- [Watching Agents Work](https://docs.paperclip.ing/guides/getting-started/watching-agents-work/) — what a healthy first heartbeat looks like.
- [Heartbeats & Routines](https://docs.paperclip.ing/guides/projects-workflow/routines/) — timer vs assignment-driven wakes.
- [Activity Log](https://docs.paperclip.ing/guides/day-to-day/activity-log/) — structural events when comments don't tell the full story.
