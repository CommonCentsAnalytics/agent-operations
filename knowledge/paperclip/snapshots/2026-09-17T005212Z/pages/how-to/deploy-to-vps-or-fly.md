> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/deploy-to-vps-or-fly/
> Retrieved: 2026-09-17T00:52:16.831295+00:00
...
- A hosted Postgres (Supabase, Neon, Fly Postgres). Embedded Postgres is for local only — see [Database](https://docs.paperclip.ing/reference/deploy/database/).
...
Front it with Caddy or Nginx for TLS. See the [Docker reference](https://docs.paperclip.ing/reference/deploy/docker/) for the full env-var surface.
...
Postgres backups are your provider's responsibility — turn them on. For company data and uploads, schedule a recurring CEO-safe export — see [Back Up and Restore a Company](https://docs.paperclip.ing/how-to/back-up-and-restore-a-company/) for the full recipe.
...
- [Back Up and Restore a Company](https://docs.paperclip.ing/how-to/back-up-and-restore-a-company/) — nightly export routine and disaster-recovery flow.
- [Export & Import](https://docs.paperclip.ing/guides/power/export-import/) — package format and CLI shortcuts.
- [Debug a stuck heartbeat](https://docs.paperclip.ing/how-to/debug-stuck-heartbeat/) — first place to look when agents misbehave.
- [Deployment overview](https://docs.paperclip.ing/reference/deploy/overview/) — full reference for modes, storage, and secrets.
