> Official reference snapshot. Source: https://docs.paperclip.ing/how-to/enable-multi-user-login/
> Retrieved: 2026-09-17T00:52:16.121537+00:00
...
The full comparison, including when to pick each, is in [Deployment Modes](https://docs.paperclip.ing/reference/deploy/deployment-modes/).
...
See [Tailscale Private Access](https://docs.paperclip.ing/reference/deploy/tailscale-private-access/) for the full private-network workflow.
...
The full walkthrough of this page is in [CLI Auth & Board Claim](https://docs.paperclip.ing/administration/cli-auth/).
...
Details in [CLI Auth & Board Claim → Device-code flow](https://docs.paperclip.ing/administration/cli-auth/#device-code-flow-paperclipai-auth-login).
...
**→ [Add a human teammate](https://docs.paperclip.ing/how-to/add-a-human-teammate/)**

If you're hosting several companies on one instance, you can also grant people access centrally from **Settings → Instance: Access** — see [Settings](https://docs.paperclip.ing/administration/settings/#instance-access).
...
- [Deployment Modes](https://docs.paperclip.ing/reference/deploy/deployment-modes/) — the authoritative reference for modes and exposure.
- [CLI Auth & Board Claim](https://docs.paperclip.ing/administration/cli-auth/) — the board-claim page and CLI login in detail.
- [Add a human teammate](https://docs.paperclip.ing/how-to/add-a-human-teammate/) — onboarding people once login is on.
- [Roles & Permissions](https://docs.paperclip.ing/administration/roles-and-permissions/) — what those teammates can do once they're in.
