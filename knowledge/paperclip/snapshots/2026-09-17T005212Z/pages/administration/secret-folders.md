> Official reference snapshot. Source: https://docs.paperclip.ing/administration/secret-folders/
> Retrieved: 2026-09-17T00:52:17.495027+00:00
...
Open any secret and you'll find an **Agent access** panel listing the agents that receive it as an environment variable when a run starts. For a user-scoped secret, what each agent receives is the value belonging to the [responsible user](https://docs.paperclip.ing/administration/secret-scopes/) for that run.
...
- [Secret scopes and the responsible user](https://docs.paperclip.ing/administration/secret-scopes/) explains company versus per-user values and the dispatch check.
- [Secrets reference](https://docs.paperclip.ing/reference/deploy/secrets/) covers providers, vaults, and secret references.
