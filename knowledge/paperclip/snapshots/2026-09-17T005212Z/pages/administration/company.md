> Official reference snapshot. Source: https://docs.paperclip.ing/administration/company/
> Retrieved: 2026-09-17T00:52:17.322137+00:00
...
This guide walks through each of those surfaces in the order you typically meet them: **General Settings**, **Members** (whose **Invites** tab now lives alongside the member list), **Join Requests**, **Export**, and **Import**. If you are looking for how hiring approvals themselves work, see the [Approvals guide](https://docs.paperclip.ing/guides/day-to-day/approvals/). If you want to understand the reporting tree that sits underneath the membership model, see [Org Structure](https://docs.paperclip.ing/guides/org/org-structure/).
...
Company and instance settings now share one navigation, so this is also where the instance-wide general controls appear. If you are an instance admin, the deployment and auth readiness summary, backup retention, keyboard shortcuts, log censoring, and AI feedback-sharing controls all render on this same **General** page — see [Settings](https://docs.paperclip.ing/administration/settings/#instance-general) for what each one does. The sections below cover the organization-specific settings.

[Image reference: Company general settings](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/settings.png)
...
- **Require board approval for new hires** — when on, every agent the CEO or a manager tries to hire stays pending until a board member approves it from the approvals queue. When off, hires go through immediately. This ties directly into the flow described in the [Approvals guide](https://docs.paperclip.ing/guides/day-to-day/approvals/).
...
[Image reference: Members list](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/access.png)
...
For the exact list of what each role grants by default, and what every permission key controls, see [Roles & Permissions](https://docs.paperclip.ing/administration/roles-and-permissions/).

> **Note:** Paperclip's agent chain of command (CEO, managers, reports) is separate from these human roles. Human roles gate access to the Paperclip UI and company-level actions; agent roles describe the reporting tree inside the company. See [Org Structure](https://docs.paperclip.ing/guides/org/org-structure/) for the agent side.
...
[Image reference: Invite link creator](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/invites.png)
...
[Image reference: Join request queue](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/join-requests.png)
...
[Image reference: Export dialog](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/export.png)
...
For a deeper description of what lives in each file, see [Export & Import](https://docs.paperclip.ing/guides/power/export-import/).
...
[Image reference: Import dialog](https://docs.paperclip.ing/administration/company/user-guides/screenshots/dark/company/import.png)
...
See [Export & Import](https://docs.paperclip.ing/guides/power/export-import/) for the structural reference — the field-by-field description of the package format complements the walkthrough above.
