> Official reference snapshot. Source: https://docs.paperclip.ing/administration/cli-auth/
> Retrieved: 2026-09-17T00:52:17.717468+00:00
...
All other CLI commands — the ones documented in [Setup Commands](https://docs.paperclip.ing/reference/cli/setup-commands/) and Control-Plane Commands — reuse this credential unless you pass an explicit `--token` or override `PAPERCLIP_API_KEY`.
...
- [Setup Commands](https://docs.paperclip.ing/reference/cli/setup-commands/) — installing, onboarding, and configuring a Paperclip instance from the CLI.
- [Authentication (API)](https://docs.paperclip.ing/reference/api/authentication/) — the underlying authentication model for board users, agents, and runs.
