> Official reference snapshot. Source: https://docs.paperclip.ing/reference/plugins/workspace-diff/
> Retrieved: 2026-09-17T00:52:23.453032+00:00
...
If you're running from a monorepo checkout, see [Develop a plugin locally](https://docs.paperclip.ing/how-to/develop-a-plugin-locally/) and point the installer at `packages/plugins/plugin-workspace-diff` instead.
...
- [Administration → Plugins](https://docs.paperclip.ing/administration/plugins/) — the operator-facing Plugin Manager.
- [How-to → Develop a plugin locally](https://docs.paperclip.ing/how-to/develop-a-plugin-locally/) — point Paperclip at a local checkout of the plugin.
- [Reference → Plugin SDK](https://docs.paperclip.ing/reference/plugins/sdk/) — the authoring surface, if you want to extend the diff viewer or write your own detail-tab plugin.
