> Official reference snapshot. Source: https://docs.paperclip.ing/reference/plugins/llm-wiki/
> Retrieved: 2026-09-17T00:52:23.389087+00:00
...
If you're running from a monorepo checkout, see [Develop a plugin locally](https://docs.paperclip.ing/how-to/develop-a-plugin-locally/) and point the installer at `packages/plugins/plugin-llm-wiki` instead.
...
- [Reference → Plugin SDK](https://docs.paperclip.ing/reference/plugins/sdk/) — the authoring surface, if you want to extend the wiki plugin or write your own.
