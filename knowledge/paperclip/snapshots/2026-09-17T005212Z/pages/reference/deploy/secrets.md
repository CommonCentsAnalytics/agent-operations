> Official reference snapshot. Source: https://docs.paperclip.ing/reference/deploy/secrets/
> Retrieved: 2026-09-17T00:52:23.826430+00:00
...
Each routine run pins itself to the routine revision it executed under via `routine_runs.routine_revision_id`, so historical runs keep the env they were dispatched with even after you edit the routine. See [Create a routine — env map](https://docs.paperclip.ing/how-to/create-a-daily-routine/#4-optional-give-the-routine-an-env-map) for the UI and API walkthrough.
