> Official reference snapshot. Source: https://docs.paperclip.ing/reference/deploy/local-development/
> Retrieved: 2026-09-17T00:52:23.630575+00:00
...
The first start automatically uses embedded PostgreSQL if `DATABASE_URL` is unset. See [Database](https://docs.paperclip.ing/reference/deploy/database/) for the storage modes behind that behavior.
...
See [Tailscale Private Access](https://docs.paperclip.ing/reference/deploy/tailscale-private-access/) for the full workflow.
