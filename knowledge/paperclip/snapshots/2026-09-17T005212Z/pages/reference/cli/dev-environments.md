> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/dev-environments/
> Retrieved: 2026-09-17T00:52:19.834769+00:00
...
- [Setup commands](https://docs.paperclip.ing/reference/cli/setup-commands/) — `run`, onboarding, and instance-level configuration that every worktree instance inherits.
- [Common options](https://docs.paperclip.ing/reference/cli/common-options/) — the shared `--data-dir`, `--api-base`, `--profile`, and `--json` flags.
- [Output and scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — consuming `--json` output from the worktree and env-lab commands.
- [Adapter reference](https://docs.paperclip.ing/reference/cli/adapter/) — adapters are what the SSH env-lab fixture exists to exercise.
- [Authentication](https://docs.paperclip.ing/reference/cli/authentication/) — how each worktree instance resolves its own credentials and context.
