> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/prompt/
> Retrieved: 2026-09-17T00:52:20.347401+00:00
...
- [Agent commands](https://docs.paperclip.ing/reference/cli/agent/) — inspect agents, set up `agent local-cli`, and wake agents directly.
- [Issue commands](https://docs.paperclip.ing/reference/cli/issue/) — list, get, update, and comment on the tasks that handoff creates.
- [Run inspection](https://docs.paperclip.ing/reference/cli/run/) — watch the server-side run that a wakeup schedules.
- [Authentication](https://docs.paperclip.ing/reference/cli/authentication/) — mint the agent keys and board tokens these commands consume.
- [Common options](https://docs.paperclip.ing/reference/cli/common-options/) — `--api-base`, `--api-key`, `--context`, `--profile`, `--json`, and the rest.
- [Output and scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — work with `--json` results in pipelines.
