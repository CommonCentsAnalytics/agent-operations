> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/project/
> Retrieved: 2026-09-17T00:52:20.063003+00:00
...
| `--env-json <json>` | Project `env` binding as a JSON object. See [JSON fields](https://docs.paperclip.ing/reference/cli/project/#json-fields-env-and-execution-workspace-policy). |
...
- [Goal Commands](https://docs.paperclip.ing/reference/cli/goal/) — manage the goals that projects link to with `--goal-ids`.
- [Issue Commands](https://docs.paperclip.ing/reference/cli/issue/) — the work objects that live inside projects and inherit their execution defaults.
- [Agent Commands](https://docs.paperclip.ing/reference/cli/agent/) — the agents you assign as a project's lead.
- [Workspace Commands](https://docs.paperclip.ing/reference/cli/workspace/) — inspect and operate the execution workspaces shaped by the execution workspace policy.
- [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) — the shared client flags every command accepts.
- [Output And Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — how `--json` output behaves and how to consume it.
