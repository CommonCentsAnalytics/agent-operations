> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/run/
> Retrieved: 2026-09-17T00:52:20.444121+00:00
...
See [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) for the full flag reference and the exact API base resolution order, and [Output and Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) for working with `--json`.
...
This is the read-heavy half of operating a company from the CLI. The mutating half — waking agents, assigning work, posting comments — lives with the [`agent`](https://docs.paperclip.ing/reference/cli/agent/) and [`issue`](https://docs.paperclip.ing/reference/cli/issue/) commands.

---

## See also

- [Agent Commands](https://docs.paperclip.ing/reference/cli/agent/) — wake agents and set up local agent CLI sessions; the source of the runs you observe here.
- [Issue Commands](https://docs.paperclip.ing/reference/cli/issue/) — manage the tasks a run creates and touches.
- [Prompt Commands](https://docs.paperclip.ing/reference/cli/prompt/) — hand work to an agent as a task that wakes it and produces a run.
- [Dashboard Commands](https://docs.paperclip.ing/reference/cli/dashboard/) — the same top-level company state the UI shows.
- [Activity Commands](https://docs.paperclip.ing/reference/cli/activity/) — the audit trail behind run-driven changes.
- [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) — shared flags and API base resolution.
- [Output and Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — working with `--json` and piping run data.
