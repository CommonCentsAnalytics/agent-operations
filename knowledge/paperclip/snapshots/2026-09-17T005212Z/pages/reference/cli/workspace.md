> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/workspace/
> Retrieved: 2026-09-17T00:52:20.803668+00:00
...
> **Note:** Every command here accepts the common client flags — `--data-dir`, `--api-base`, `--api-key`, `--context`, `--profile`, and `--json`. See [Common Options](https://docs.paperclip.ing/reference/cli/common-options/). Company-scoped subcommands also accept `-C, --company-id <id>`; ID- and project-scoped subcommands take the id as a positional argument instead.
...
- [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) — the client flags every command above accepts.
- [Output and Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — using `--json` and piping results.
- [Project Commands](https://docs.paperclip.ing/reference/cli/project/) — managing the projects that own project workspaces.
- [Dev Environments](https://docs.paperclip.ing/reference/cli/dev-environments/) — the broader environment and SSH-fixture setup story.
- [Run Commands](https://docs.paperclip.ing/reference/cli/run/) — inspecting the heartbeat runs that execute inside these workspaces.
- [Adapter Commands](https://docs.paperclip.ing/reference/cli/adapter/) — the adapter/model configuration that `agent-config list` summarizes.
