> Official reference snapshot. Source: https://docs.paperclip.ing/reference/cli/cost/
> Retrieved: 2026-09-17T00:52:20.733619+00:00
...
Every command on this page accepts the standard client flags. See [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) for the full list and [Output and Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) for `--json` usage.
...
- [Common Options](https://docs.paperclip.ing/reference/cli/common-options/) — the client flags every command here accepts
- [Output and Scripting](https://docs.paperclip.ing/reference/cli/output-and-scripting/) — using `--json` to wire these reads into monitoring
- [Dashboard Commands](https://docs.paperclip.ing/reference/cli/dashboard/) — the top-level company state, including a spend view
- [Activity Commands](https://docs.paperclip.ing/reference/cli/activity/) — the audit trail behind budget incidents and spend
- [Agent Commands](https://docs.paperclip.ing/reference/cli/agent/) — the agents whose spend `cost by-agent` and `budget agent:update` govern
- [Approval Commands](https://docs.paperclip.ing/reference/cli/approval/) — the board gate that pairs with budgets for high-cost actions
