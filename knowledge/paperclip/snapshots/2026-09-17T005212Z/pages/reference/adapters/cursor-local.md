> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/cursor-local/
> Retrieved: 2026-09-17T00:52:22.450166+00:00
...
- You need webhook-style external invocation. Use [OpenClaw Gateway](https://docs.paperclip.ing/reference/adapters/openclaw-gateway/) or [HTTP](https://docs.paperclip.ing/reference/adapters/http/).
- You only need one-shot shell commands. Use [Process](https://docs.paperclip.ing/reference/adapters/process/).
