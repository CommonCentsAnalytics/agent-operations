> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/cursor-cloud/
> Retrieved: 2026-09-17T00:52:22.457236+00:00
...
- You want local execution on the same machine as Paperclip. Use [Cursor Local](https://docs.paperclip.ing/reference/adapters/cursor-local/).
...
- [Cursor Local](https://docs.paperclip.ing/reference/adapters/cursor-local/) — same agent vendor, local execution.
