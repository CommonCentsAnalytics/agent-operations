> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/claude-code/
> Retrieved: 2026-09-17T00:52:22.214493+00:00
...
- The agent runs on another machine or behind a webhook. Use [HTTP](https://docs.paperclip.ing/reference/adapters/http/) instead.
- You only need a one-shot script or command. Use [Process](https://docs.paperclip.ing/reference/adapters/process/).
...
| `engine` | no | How Claude Code is run: `auto` (the default — ACP preferred), `acp` (always the Agent Client Protocol), or `cli` (always the classic Claude CLI). See [ACP Engine](https://docs.paperclip.ing/reference/adapters/claude-code/#acp-engine). |
