> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/modal/
> Retrieved: 2026-09-17T00:52:23.159166+00:00
...
- You already standardise on a different sandbox provider (Cloudflare, Daytona, E2B, exe.dev). See [Sandbox Providers](https://docs.paperclip.ing/reference/adapters/sandbox-providers/).
...
From the [Plugins](https://docs.paperclip.ing/administration/plugins/) page, install:
...
- [Sandbox Providers](https://docs.paperclip.ing/reference/adapters/sandbox-providers/) — overview of all sandbox provider plugins.
