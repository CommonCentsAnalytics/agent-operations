> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/openclaw-gateway/
> Retrieved: 2026-09-17T00:52:22.914033+00:00
...
- The remote agent doesn't speak the OpenClaw Gateway protocol. Use [HTTP](https://docs.paperclip.ing/reference/adapters/http/).
- You want to run a headless local CLI agent on the same machine. Use [Claude Code](https://docs.paperclip.ing/reference/adapters/claude-code/), [Codex](https://docs.paperclip.ing/reference/adapters/codex/), or [Process](https://docs.paperclip.ing/reference/adapters/process/).
