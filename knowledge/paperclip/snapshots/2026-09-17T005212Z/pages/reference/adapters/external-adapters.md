> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/external-adapters/
> Retrieved: 2026-09-17T00:52:23.189461+00:00
...
- You only need a one-off local command. Use [Process](https://docs.paperclip.ing/reference/adapters/process/).
...
The operator-facing walkthrough of pausing, resuming, and removing overrides lives in [Settings → Instance: Adapters](https://docs.paperclip.ing/administration/settings/).
