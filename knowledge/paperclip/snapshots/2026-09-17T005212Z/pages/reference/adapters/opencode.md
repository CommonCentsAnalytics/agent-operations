> Official reference snapshot. Source: https://docs.paperclip.ing/reference/adapters/opencode/
> Retrieved: 2026-09-17T00:52:22.577338+00:00
...
- The runtime lives behind a webhook or API. Use [OpenClaw Gateway](https://docs.paperclip.ing/reference/adapters/openclaw-gateway/) or [HTTP](https://docs.paperclip.ing/reference/adapters/http/).
- You only need a one-shot shell command or script. Use [Process](https://docs.paperclip.ing/reference/adapters/process/).
