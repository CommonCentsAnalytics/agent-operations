> Official reference snapshot. Source: https://docs.paperclip.ing/reference/skills/bundled/paperclip-operations/status-card-query/
> Retrieved: 2026-09-17T00:52:21.524723+00:00
...
Status cards are an experimental feature. The authoring routes are available only when `enableStatusCards` is turned on — see [Status Cards](https://docs.paperclip.ing/experimental/status-cards/) for the feature itself and the [Status Cards API](https://docs.paperclip.ing/reference/api/status-cards/) for the full route reference.
...
- [Status Cards](https://docs.paperclip.ing/experimental/status-cards/) — the experimental feature this skill supports.
- [Status Cards API](https://docs.paperclip.ing/reference/api/status-cards/) — the full route and payload reference.
