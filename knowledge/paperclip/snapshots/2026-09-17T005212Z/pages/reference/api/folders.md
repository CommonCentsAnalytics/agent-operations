> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/folders/
> Retrieved: 2026-09-17T00:52:18.593833+00:00
...
Folders are company-scoped, and — like the rest of the control-plane API — company access is enforced on every request. If you are new to the API, read the [API Overview](https://docs.paperclip.ing/reference/api/overview/) first for base URL, authentication, and error-code conventions; this page builds on those and won't repeat them.
...
- [Routines](https://docs.paperclip.ing/reference/api/routines/) — the scheduled work that `kind: "routine"` folders organise.
- [Activity](https://docs.paperclip.ing/reference/api/activity/) — where the `folder.*` entries above show up.
