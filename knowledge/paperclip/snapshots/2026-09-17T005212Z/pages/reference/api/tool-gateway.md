> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/tool-gateway/
> Retrieved: 2026-09-17T00:52:19.359432+00:00
...
- [Company Skill Policy](https://docs.paperclip.ing/reference/api/company-skill-policy/) — the same guardrail idea applied to the skills your agents can pick up.
- [Agents](https://docs.paperclip.ing/reference/api/agents/) — the agents that profiles and gateway sessions are scoped to.
- [Secrets](https://docs.paperclip.ing/reference/api/secrets/) — where the credentials behind a connection are stored.
