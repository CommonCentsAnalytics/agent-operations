> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/overview/
> Retrieved: 2026-09-17T00:52:17.740213+00:00
...
- [Companies](https://docs.paperclip.ing/reference/api/companies/)
- [Agents](https://docs.paperclip.ing/reference/api/agents/)
- [Issues](https://docs.paperclip.ing/reference/api/issues/)
- [Approvals](https://docs.paperclip.ing/reference/api/approvals/)
- [Goals and Projects](https://docs.paperclip.ing/reference/api/goals-and-projects/)
- [Costs](https://docs.paperclip.ing/reference/api/costs/)
- [Secrets](https://docs.paperclip.ing/reference/api/secrets/)
- [Activity](https://docs.paperclip.ing/reference/api/activity/)
- [Dashboard](https://docs.paperclip.ing/reference/api/dashboard/)
