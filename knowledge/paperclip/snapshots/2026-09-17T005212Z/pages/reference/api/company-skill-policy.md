> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/company-skill-policy/
> Retrieved: 2026-09-17T00:52:18.601827+00:00
...
- [Agents](https://docs.paperclip.ing/reference/api/agents/) — the agents you name in `subject.agentIds` and in `principal.agentId`.
- [Activity](https://docs.paperclip.ing/reference/api/activity/) — where `company.skill_policy_replaced` and `company.skill_policy_reset` land.
