> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/resource-memberships/
> Retrieved: 2026-09-17T00:52:18.512416+00:00
...
To browse the documents you have starred, call the company artifacts list with `starred=true` — see [Companies](https://docs.paperclip.ing/reference/api/companies/).
