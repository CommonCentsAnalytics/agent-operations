> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/teams-catalog/
> Retrieved: 2026-09-17T00:52:19.369541+00:00
...
For the user-facing concept and CLI workflow, see [Teams Commands](https://docs.paperclip.ing/reference/cli/teams/) and the [Team Catalog guide](https://docs.paperclip.ing/guides/org/team-catalog/). This page documents the raw HTTP endpoints that those tools call.
