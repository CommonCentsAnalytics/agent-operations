> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/summary-slots/
> Retrieved: 2026-09-17T00:52:18.947820+00:00
...
Summary slots are company-scoped, and company access is enforced on every request. If you are new to the API, read the [API Overview](https://docs.paperclip.ing/reference/api/overview/) first for base URL, authentication, and error-code conventions — this page builds on those and won't repeat them.
...
You also need the Summarizer built-in agent provisioned and ready for the company. Generation refuses to start otherwise; see [Asking for a summary](https://docs.paperclip.ing/reference/api/summary-slots/#asking-for-a-summary) below and the [Built-in Agents](https://docs.paperclip.ing/reference/api/built-in-agents/) page for how to provision one.
...
See the [Activity](https://docs.paperclip.ing/reference/api/activity/) page for how to read the log.

---

## Where to go next

- [Built-in Agents](https://docs.paperclip.ing/reference/api/built-in-agents/) — how to provision the Summarizer, and what its lifecycle states mean.
- [Issues](https://docs.paperclip.ing/reference/api/issues/) — the generation tasks created by `POST .../generate` are ordinary issues.
- [Goals and Projects](https://docs.paperclip.ing/reference/api/goals-and-projects/) — the projects and workspaces a summary slot can be scoped to.
