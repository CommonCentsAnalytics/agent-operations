> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/adapters/
> Retrieved: 2026-09-17T00:52:19.155166+00:00
...
For per-adapter configuration semantics, jump to [Reference → Adapters → Overview](https://docs.paperclip.ing/reference/adapters/overview/). This page documents the REST endpoints.
...
Serves the adapter-supplied UI parser bundle. The Paperclip UI fetches this script to render run output for the adapter. The wire contract is documented in [Adapter UI Parser](https://docs.paperclip.ing/reference/adapters/adapter-ui-parser/).
