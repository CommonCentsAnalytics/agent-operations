> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/plugins/
> Retrieved: 2026-09-17T00:52:19.335534+00:00
...
For the operator-facing walkthrough see [Administration → Plugins](https://docs.paperclip.ing/administration/plugins/). For the authoring SDK see [Reference → Plugins → Plugin SDK](https://docs.paperclip.ing/reference/plugins/sdk/).
