> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/decision-training/
> Retrieved: 2026-09-17T00:52:18.885773+00:00
...
Decision training examples are company-scoped, and company access is enforced on every request. If you are new to the API, read the [API Overview](https://docs.paperclip.ing/reference/api/overview/) first for base URL, authentication, and error-code conventions; this page builds on those and won't repeat them.
...
- [Issues](https://docs.paperclip.ing/reference/api/issues/) — the issues decision training examples hang off, and the source of the thread interactions you can capture.
- [Approvals](https://docs.paperclip.ing/reference/api/approvals/) — the approval requests you can capture with `sourceKind: "approval"`.
- [Activity](https://docs.paperclip.ing/reference/api/activity/) — where the `decision_training.*` entries described on this page show up.
