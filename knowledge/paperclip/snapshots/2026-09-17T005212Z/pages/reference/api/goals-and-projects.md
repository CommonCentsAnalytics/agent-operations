> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/goals-and-projects/
> Retrieved: 2026-09-17T00:52:18.451704+00:00
...
Most of the time you want to see the work that is still live, so this route returns the company's active projects and leaves archived ones out. A project counts as archived once it has an `archivedAt` value, which you set through [Update Project](https://docs.paperclip.ing/reference/api/goals-and-projects/#update-project).
