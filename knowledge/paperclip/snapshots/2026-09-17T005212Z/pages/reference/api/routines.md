> Official reference snapshot. Source: https://docs.paperclip.ing/reference/api/routines/
> Retrieved: 2026-09-17T00:52:19.101001+00:00
...
| `activityGatePolicy` | no | `always` (default) or `require_external_activity`. See [Activity Gate](https://docs.paperclip.ing/reference/api/routines/#activity-gate). |
