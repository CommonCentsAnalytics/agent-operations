> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/connections-apps/
> Retrieved: 2026-09-17T00:52:15.360788+00:00
...
- [Experimental features overview](https://docs.paperclip.ing/experimental/overview/) — how experimental flags work and what "no compatibility guarantees" means.
- [Cloud Sync](https://docs.paperclip.ing/experimental/cloud-sync/) — **retired**, removed upstream along with its toggle. To move a company between instances, use [company Import/Export](https://docs.paperclip.ing/how-to/back-up-and-restore-a-company/) instead.
