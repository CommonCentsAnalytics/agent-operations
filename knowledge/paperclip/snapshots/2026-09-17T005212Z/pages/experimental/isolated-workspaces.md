> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/isolated-workspaces/
> Retrieved: 2026-09-17T00:52:15.496995+00:00
...
[Image reference: The Workspaces screen](https://docs.paperclip.ing/experimental/isolated-workspaces/user-guides/screenshots/dark/workspaces/list.png)
...
The full tour of the workspace detail screen — tabs, runtime controls, logs — is in the [Workspaces guide](https://docs.paperclip.ing/guides/projects-workflow/workspaces/).
...
If a task also runs on an [environment](https://docs.paperclip.ing/experimental/environments/) — an SSH machine or a provider sandbox — there's one more question to settle: which filesystem the agent actually edits. Paperclip records that as the run's *workspace realization*, and it has two modes.
...
- The advanced **Environment** dropdown in the same section needs the [Environments](https://docs.paperclip.ing/experimental/environments/) flag and more than one selectable environment.
...
- [Workspaces](https://docs.paperclip.ing/guides/projects-workflow/workspaces/) — the full guide to execution workspaces and the workspace detail screen.
- [Projects](https://docs.paperclip.ing/guides/projects-workflow/projects/) — project configuration in general.
