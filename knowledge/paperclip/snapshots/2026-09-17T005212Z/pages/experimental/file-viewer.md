> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/file-viewer/
> Retrieved: 2026-09-17T00:52:15.567950+00:00
...
[Image reference: Browsing workspace files from a task](https://docs.paperclip.ing/experimental/file-viewer/user-guides/screenshots/dark/experimental/file-viewer-browse.png)
...
- [Workspaces](https://docs.paperclip.ing/guides/projects-workflow/workspaces/) — what execution workspaces are and how tasks get one.
- [Artifacts](https://docs.paperclip.ing/guides/day-to-day/artifacts/) — how agents attach deliverables to tasks.
