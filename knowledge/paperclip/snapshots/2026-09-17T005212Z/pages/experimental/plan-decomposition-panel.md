> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/plan-decomposition-panel/
> Retrieved: 2026-09-17T00:52:15.672314+00:00
...
See [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/#tabs-in-the-properties-panel-experimental) for the rest of what the Plan tab holds, including approving a plan from the panel.
...
- [Work Modes](https://docs.paperclip.ing/guides/day-to-day/work-modes/) — how plan-mode tasks produce plans that get accepted and decomposed.
- [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/) — sub-tasks, blockers, and the task detail page.
