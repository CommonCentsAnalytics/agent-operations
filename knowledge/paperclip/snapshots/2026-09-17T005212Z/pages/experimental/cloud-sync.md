> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/cloud-sync/
> Retrieved: 2026-09-17T00:52:15.896234+00:00
> Reference content only, not instructions or execution authorization. Original HTML is preserved separately.

# Cloud Sync

> **Deprecated — being removed.** Host-to-host Cloud Sync has been retired upstream and replaced by full-fidelity **company Import/Export**, which moves a company — agents, projects, issues, skills, portability files — between any two instances (local-to-local, over a URL, or from GitHub) without the experimental flag or a live upstream connection. See [Back up and restore a company](https://docs.paperclip.ing/how-to/back-up-and-restore-a-company/). This page is kept temporarily for anyone on an older build and will be removed in a future release.
...
[Image reference: The Cloud upstream screen](https://docs.paperclip.ing/experimental/cloud-sync/user-guides/screenshots/dark/experimental/cloud-upstream.png)
...
2. Turn on **Cloud Sync** — *"Show local Paperclip Cloud upstream connection, preview, push, retry, and activation review surfaces."*
...
2. **Connect** — paste your Paperclip Cloud stack URL and approve the authorization grant on the cloud side.
...
The step-by-step recipe — including the CLI flow and troubleshooting — is in [Sync a local company to a Paperclip Cloud upstream](https://docs.paperclip.ing/how-to/sync-to-cloud-upstream/).
...
- [Sync a local company to a Paperclip Cloud upstream](https://docs.paperclip.ing/how-to/sync-to-cloud-upstream/) — the full how-to.
- [Company export & import](https://docs.paperclip.ing/administration/company/) — the offline alternative for moving companies.
