> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/status-cards/
> Retrieved: 2026-09-17T00:52:15.808547+00:00
...
[Image reference: The New card dialog: a single What do you want to keep an eye on? field with worked examples beneath it, and an Agent picker](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/new-card-dialog.png)
...
[Image reference: The Status board: one tile per card, each with a state dot, its title, the live summary, and a footer showing freshness, update policy, and today&#39;s tokens and cost](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/board.png)

- **Summary** — the current summary, plus a revision picker to read earlier ones and a list of the changes each update integrated.

[Image reference: The card detail drawer on the Summary tab, showing the current summary and its revision picker](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/detail-summary.png)
...
[Image reference: The Watched issues tab listing the issues the compiled query matches right now](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/detail-watched-issues.png)

- **History** — every update with its trigger, tokens, cost, model, and any error.

[Image reference: The History tab, one row per update with its trigger, tokens, cost, and model](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/detail-history.png)
...
[Image reference: The Settings tab showing the auto-update policy modes and the Advanced section of change triggers](https://docs.paperclip.ing/experimental/status-cards/user-guides/screenshots/dark/status-cards/detail-settings.png)
...
- [Status Cards API](https://docs.paperclip.ing/reference/api/status-cards/) — every route, its permissions, and the agent-authoring rules.
- [Summary Slots](https://docs.paperclip.ing/reference/api/summary-slots/) — the other place the Summarizer writes, fixed to a project or workspace header.
