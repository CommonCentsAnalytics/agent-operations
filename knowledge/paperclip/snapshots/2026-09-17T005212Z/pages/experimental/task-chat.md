> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/task-chat/
> Retrieved: 2026-09-17T00:52:15.755568+00:00
...
This one is yours to decide. Unlike most flags on this page it's classed as a taste setting rather than a fleet setting, so it never picks up a **Managed by Paperclip Cloud** lock badge — see [If a toggle is locked](https://docs.paperclip.ing/experimental/overview/#if-a-toggle-is-locked). It's off by default on Cloud and self-hosted instances alike.
...
[Image reference: The task page with Chat-Style Tasks on: the thread fills the centre column as a conversation, with the properties pane on the right](https://docs.paperclip.ing/experimental/task-chat/user-guides/screenshots/dark/task-chat/thread.png)
...
[Image reference: The composer&#39;s mode picker open, offering Agent mode, Plan mode, and Ask mode](https://docs.paperclip.ing/experimental/task-chat/user-guides/screenshots/dark/task-chat/composer-modes.png)
...
[Image reference: The side pane on the right of the task page, with its Properties, Plan, and Artifacts tabs](https://docs.paperclip.ing/experimental/task-chat/user-guides/screenshots/dark/task-chat/side-pane.png)
...
- [Work Modes](https://docs.paperclip.ing/guides/day-to-day/work-modes/) — what Agent, Plan, and Ask modes actually change about a run.
- [Issues](https://docs.paperclip.ing/guides/day-to-day/issues/) — the task detail page, sub-tasks, and blockers.
- [Artifacts](https://docs.paperclip.ing/guides/day-to-day/artifacts/) — where a task's outputs come from.
