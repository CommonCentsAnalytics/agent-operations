> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/external-objects/
> Retrieved: 2026-09-17T00:52:15.563273+00:00
...
[Image reference: External object status on an issue](https://docs.paperclip.ing/experimental/external-objects/user-guides/screenshots/dark/experimental/external-objects.png)
...
- [Secrets & scopes](https://docs.paperclip.ing/administration/secret-scopes/) — where the GitHub token lives.
- [Plugins](https://docs.paperclip.ing/administration/plugins/) — extending detection to other providers.
