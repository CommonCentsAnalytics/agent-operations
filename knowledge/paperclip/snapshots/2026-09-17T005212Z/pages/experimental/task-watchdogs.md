> Official reference snapshot. Source: https://docs.paperclip.ing/experimental/task-watchdogs/
> Retrieved: 2026-09-17T00:52:15.768647+00:00
...
[Image reference: A watchdog reporting its verdict in the task thread](https://docs.paperclip.ing/experimental/task-watchdogs/user-guides/screenshots/dark/watchdogs/watchdog-thread-outcome.png)
...
The full lifecycle — when a watchdog wakes, what it's allowed to do, and how it differs from the other things called "watchdog" — is covered in the [Task Watchdogs guide](https://docs.paperclip.ing/guides/projects-workflow/task-watchdogs/).
...
- [Task Watchdogs guide](https://docs.paperclip.ing/guides/projects-workflow/task-watchdogs/) — the full lifecycle, decision model, and configuration reference.
